...
public class UIManager : MonoBehaviour
{
    ...
    public void SetDialogueTextList()
    {
        ...
        if (dialoguePanel != null)
        {
            ...
            dialogueTextList.Add("Use the w a s d keys to pilot the ship, and use Space Key to shoot at any target that gets in your way.");
            ...
            dialogueTextList.Add("Use the arrow keys to pilot the ship, and use the num pad 5 to shoot, making your target pays for his viciousness.");
